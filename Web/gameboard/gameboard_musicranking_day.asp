...
<%
	...
	oConn.CursorLocation = adUseClient
   	oConn.Open sConnection_string
    	...
    	sUpdateDateDay = CStr( Year(dateUpdateDate) ) & "/" & CStr( Month(dateUpdateDate) ) & "/" & CStr( Day(dateUpdateDate) )
   	...
   	iWeekCount = DateDiff("ww", dateMonthFirstDay, dateUpdateEndWeek)
    	...
    	sUpdateDateWeek = CStr(Year(dateUpdateEndWeek)) & "쾨 " & CStr(Month(dateUpdateEndWeek)) & "월 " & iWeekCount + 1 & "번째주 (" & iStartWeekMonth & "월 " & iStartWeekDay & "일~" & iEndWeekMonth & "월 " & iEndWeekDay & "일)순위"

    	dateUpdateEndWeek = DateAdd( "d", 7 - Weekday(dateUpdateDate) - 7 , dateUpdateDate ) 
    	
    	datePreMonth = DateAdd( "m", -1 , dateUpdateDate )

	sUpdateDateMonth = CStr( Year(datePreMonth) ) & "쾨 " & CStr( Month(datePreMonth) ) & "월 순위"
%>
...
<table width="730" height="450" border="0" cellspacing="0" cellpadding="0">
  <tr> 
              ...
              <tr> 
                ...
                <td align="right" background="/images/gameboard/musicranking/music_topbg_02.gif"><table border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td width="130" align="center" background="/images/gameboard/musicranking/music_topbg01_02.gif" class="txtWhite"><font size=1>Updated at <%=sUpdateDateDay%></font></td>
...
<iframe src="r_day.asp" frameborder="0" width="560" height="340" scrolling="yes" vspace="5"></iframe>
				</td>
