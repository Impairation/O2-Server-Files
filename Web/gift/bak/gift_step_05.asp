	...
	%>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
				...
				<%IF sumPrice <> 0 THEN%>				 
                  : <span class="txtYellowB"><%=formatNumber(sumPrice,0)%>点</span>
                ...
                <td align="center" class="txtDarkblue">
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      <td align="right"><span class="txtDarkviolet">总额</span> 
                        ::</td>
                      <td width="20%" align="right" class="txtDarkviolet"><strong><%=FormatNumber(sumPrice,0)%></strong> 点</td>
                    </tr>
                  </table>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      ...
                      <% End If %>
                      <td width="20%" align="right" class="txtDarkviolet"><strong><%=FormatNumber(OrderPrice,0)%> 点</strong></td>
                    </tr>
                  </table>
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      <td align="right" class="txtDarkviolet">已使用的 GEM ::</td>
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      <td align="right" class="txtDarkviolet">储备金 :: </td>
                      <td width="20%" align="right" class="txtDarkviolet"><strong>0 盔</strong></td>
                    </tr>
                  </table>
					<% End If %>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      ...
                      <td width="20%" align="right"><strong><%=FormatNumber(MCash,0)%></strong> 点</td>
                    </tr>
                  </table>
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      <td align="right">剩余 Gem ::</td>
                      <td width="20%" align="right"><strong><%=FormatNumber(Gem,0)%></strong> 点</td>
                    </tr>
                  </table>
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      <td align="right"><!-- 剩余o2货币 :: --></td>
                      <td width="20%" align="right"><!-- <strong><%=FormatNumber(O2Cash,0)%></strong> 点 --></td>
                    </tr>
                  </table>
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      <td align="right"><!-- 剩余音乐货币 :: --></td>
                      <td width="20%" align="right"><!-- <strong><%=FormatNumber(MusicCash,0)%></strong> 点 --></td>
                    </tr>
                  </table>
                  <table width="95%" border="0" cellspacing="0" cellpadding="2">
                    <tr class="txtDarkblue"> 
                      <td align="right"><!-- 剩余道具货币 :: --></td>
