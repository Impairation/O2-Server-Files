...
If not(objDBrs.BOF or objDBrs.EOF) Then		'判断购物车内是否有音乐和道具
	...
	'transactCheck2=1
						...
						'将道具加入对方数据库
                        Conn1.Execute "P_o2jam_gift_item_buy "& nick_USER_INDEX_ID &", "& objDBrsIb("ID") &", "& USER_INDEX_ID &", '"& USER_NICKNAME & "'" & "," &totalrecord_price & "," &totalrecord_gem & ",3",transactCheck1						'错误捕获
